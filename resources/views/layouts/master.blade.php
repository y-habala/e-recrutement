        ...
        <div class="footer-info ptb80">
            <div class="container">
                ...
                <div class="col-md-8 col-sm-6 col-xs-6 footer-about">
                    ...
                    <!-- Small Description -->
                    <p class="pt40">Lorem ipsum dolor sont assis amet, consectetur adipiscing
                     elit. Cras felis metus, porta UT facilisis sed, dicton id dolor
                     . Entier sagittis lacus porttitor excepté commodo dignissim.
                     Curabitur excepté nisi, varius sed venenatis et, vehicula lacinia
                      risus. Fusce ullamcorper lobortis magna UT interdum. Sed id quam
                      Leo auctor iaculis. Nam nec nunc hendrerit, blandit mauris non,
                      posuere dolor.</p>
                </div>
                ...
                <div class="col-md-4 col-sm-6 col-xs-6 footer-contact">
                    ...
                    <!-- Info -->
                    <ul class="nopadding">
                        <li><i class="fa fa-map-marker"></i>ville El Jadida, maroc</li>
                        <li><i class="fa fa-phone"></i>(+212) 677 283 699</li>
                        <li><i class="fa fa-envelope-o"></i>e-recrutement@gmail.com</li>
                    </ul>
        ...
        <div class="copyright ptb40" style="background: #000000">
            <div class="container">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <span>Copyright &copy; <a href="{{url('/')}}">Mr.HABALA Youssef</a>. Tous les droits sont réservés</span>
                </div>
