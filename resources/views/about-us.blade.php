        ...
        <nav class="navbar navbar-default navbar-static-top fluid_header centered">
            <div class="container">
                ...
                <div class="col-md-2 col-sm-6 col-xs-8 nopadding">
                    <a class="navbar-brand nomargin" href="{{url('/')}}">E-Recrutement</a>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 col-xs-12">
                    ...
                    <p class="pt30"> L'e-recrutement a considérablement fait évoluer le paysage du recrutement tant pour les entreprises que pour les chercheurs d'emploi.
Les RH peuvent désormais rechercher les talents nécessaires à l'entreprise parmi un spectre beaucoup plus large.<br>effectuer une
                demande d’emploi en une minute<br>
                Postuler
                en ligne facilement.</p>
